...
describe('Documents: Create Document', () => {
  ...
  it('should return 403 if non-member creates document', async () => {
    ...
    const res = await createDocumentReq(
      orgId,
      'Test Document',
      'Test Content',
      nonMember.authToken,
    ...
    const otherOrgRes = await createDocumentReq(
      orgId,
      'Test Document',
      'Test Content',
      otherOwner.authToken,
    );
...
describe('Documents: Update Document', () => {
  ...
  it('should allow owner and member to update documents they own', async () => {
    ...
    const resMember = await editDocumentReq(
      orgId,
      memberDocRes.body.id,
      'Updated Title',
      'Updated Content',
      member.authToken,
    );
  ...
  it('should return 401 if non-creator updates document', async () => {
    ...
    const res = await editDocumentReq(
      orgId,
      memberDocRes.body.id,
      'Updated Title',
      'Updated Content',
